...
const TOAST_DELETE = document.querySelector(`.toast.delete`);
...
function newElement() {
  if (TASK_INPUT.value == null || TASK_INPUT.value.trim() == "") {
    ...
    TOAST_ERROR.classList.add(`bg-warning`, `text-light`); //! this is an extra code.
...
function deleteElement(event) {
  ...
  // Add green background and white text color to live toast.
  TOAST_DELETE.classList.add(`bg-danger`, `text-light`); //! this is an extra code.
}
